        ...
        <div className='p-6'>
          ...
          <form onSubmit={handleAddBook}>
            ...
            <div className='mb-4'>
              ...
              <textarea value={description} onChange={(e)=> setDescription(e.target.value)} placeholder="Book's Description" rows={4} className="w-full px-4 py-2 border border-black rounded-md"/>
            </div>
